...
autocmd BufRead,BufNewFile *.py let python_highlight_all=1 | colorscheme nipy
...
" for SAS, also have things in braces indented:
autocmd FileType sas set ts=8 sw=3
...
" Python
autocmd FileType python set smartindent cinwords=if,elif,else,for,while,try,except,finally,def,class tabstop=4 shiftwidth=4 smarttab expandtab softtabstop=4 autoindent

autocmd FileType sql set tabstop=4 shiftwidth=4
autocmd FileType java set tabstop=2 shiftwidth=2
autocmd FileType html set tabstop=2 shiftwidth=2
autocmd FileType xml set tabstop=2 shiftwidth=2
autocmd FileType rb set smartindent
...
map <F11> :cp<CR>
map <F10> :make<CR>
set makeprg=ant\ -emacs\ -find\ build.xml\ dist
