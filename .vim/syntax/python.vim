...
syn keyword pythonStatement     def break continue del
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonDecorator        DecDefine
  HiLink pythonDottedName       DecFunction
  ...
  HiLink pythonBuiltinFunc      PyFunction
