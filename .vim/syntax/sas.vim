...
syn match sasMacroFunction "%\w\+\s*"
...
" A little extra to get macro function names highlighted when declared
syn match sasMacroFunction "%macro\s\+\w\+"
syn match sasMacro "%MACRO"
...
if version >= 508 || !exists("did_sas_syntax_inits")
	...
	HiLink sasStep sasProcKwd
	HiLink sasFunctionName Function
	HiLink sasMacro sasMacro
	HiLink sasMacroVar Identifier
	HiLink sasMacroFunction MacroFunction
	HiLink sasNumber Fixed
	HiLink sasStatement Statement
	HiLink sasProcKwd sasProcKwd
	HiLink sasODSKwd Statement
	HiLink sasFormatValue Fixed
	HiLink sasString Special
	HiLink sasProcName Function
